...
import datetime
import re
from lib.time import verbose_timedelta, str_to_datetime
from lib.process import process_timestream
from lib.image import detect_backends
...
parser.add_argument('input',  type=str, nargs="+",
                    help='Directories containing unsorted images (assumed to be from the same camera)')
